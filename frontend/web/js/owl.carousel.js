...
(function( $, window, document, undefined ) {
	...
	var Carousel = {
		...
		calculateWidth : function(){
			var base = this;
			base.itemWidth = Math.round((base.$elem.width()/base.options.items)-14);
		},
...
//                            alert(base.$elem);
				base.owlControlls = $("<div class=\"owl-controlls\"/>").insertBefore(base.$elem);
			}
